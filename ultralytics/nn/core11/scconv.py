...
class SCConv(nn.Module):
    def __init__(self, inplanes, planes, stride, padding, dilation, groups, pooling_r, norm_layer):
        ...
        self.k2 = nn.Sequential(
            ...
            nn.Conv2d(
                inplanes, planes, kernel_size=3, stride=1, padding=padding, dilation=dilation, groups=groups, bias=False
            ),
            norm_layer(planes),
        )
...
class SCBottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv3_ = nn.Conv2d(planes * 4, planes, kernel_size=1, bias=False)
