...
def clean_thop_attrs(model):
    """
    清理 thop 注册的 total_ops / total_params
    防止重复 profile 或 hook 冲突
    """
...
if __name__ == "__main__":
    ...
    model_info_list = [
        ...
        ("CSCConvNeXtv2_CBAM_P2", r"./runs/train/uav-hongcun-fire-smoke/exp_yolo11_CSCConvNeXtv2_p2_CBAM/weights/best.pt"),
    ]
